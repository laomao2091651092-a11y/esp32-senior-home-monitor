...
// 小字体（8x16）显示函数
void lcd_show_small_char(uint16_t x, uint16_t y, uint8_t chr, uint16_t fontcolor, uint16_t backgroundcolor);
void lcd_show_small_string(uint16_t x, uint16_t y, char *string, uint16_t fontcolor, uint16_t backgroundcolor);
